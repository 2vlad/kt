...
(function () {
        ...
        CKEDITOR.tools = {
            ...
            enableHtml5Elements: function (a,
                ...
                for (var c = "abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup main mark meter nav output progress section summary time video".split(" "),
                         h = c.length, d; h--;)d = a.createElement(c[h]), b && a.appendChild(d)
            },
            ...
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, h,
                         d = 0; d < b.length; d++)if (c = b[d].split("\x3d"), h = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), h === a)return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
    ...
    (function () {
        ...
        function c(a) {
            for (var b = 0, c = 0,
                     f = k[a].length; c < f; c++)b += parseFloat(this.getComputedStyle(k[a][c]) || 0, 10) || 0;
            return b
        }
            ...
            is: function () {
                ...
                if (CKEDITOR.env.ie) {
                    ...
                    for (var a, b = this.getElementsByTag("*"), c = 0,
                             f = b.count(); c < f; c++)a = b.getItem(c), a.setAttribute("unselectable", "on")
                }
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            if (l && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(t, A)), c.append(q); else {
                ...
                for (var P = q.getParents(), v = n.getParents(), G = g(), E = P.length - 1, I = v.length - 1, K = c, L,
                         Z, X, fa = -1, S = G; S <= E; S++) {
                    Z =
                        P[S];
                    X = Z.getNext();
                        ...
                        for (l = c(l); l || q;) {
                            ...
                            for (; q;)if (A = !1, q.type == CKEDITOR.NODE_COMMENT) q = q.getPrevious(); else {
                                if (q.type == CKEDITOR.NODE_TEXT) C = q.getText(), d.test(C) && (q = null), A = /[\s\ufeff]$/.test(C); else if ((q.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && q.is("br")) && !q.data("cke-bookmark"))if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    C = q.getText();
                                    if (d.test(C)) q = null; else for (var D = q.$.getElementsByTagName("*"), M = 0,
                                                                           H; H =
    ...
    (function () {
        ...
        function l(a, b, c) {
            ...
            if (D.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(w()) : (a.parent && c.push({
                ...
                b:{
                    l = D[b];
                    for (var e = 0, q = d.length,
                             n; e < q; ++e)if (n = d[e], n.type == CKEDITOR.NODE_ELEMENT && !l[n.name]) {
                        l = !1;
                        break b
                    }
                    l = !0
                ...
                if (l) a.name = b, a.attributes =
                    ...
                    l = a.parent;
                    for (var e = l.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == l.name, t, f,
                             q = d.length; 0 < q;)n = d[--q], e && (n.type == CKEDITOR.NODE_TEXT || n.type == CKEDITOR.NODE_ELEMENT && D.$inline[n.name]) ? (t || (t = new CKEDITOR.htmlParser.element(b), t.insertAfter(a), c.push({
                        check: "parent-down",
                        el: t
            ...
            var g = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (f in a) {
                        ...
                        if (!d[f]) {
                            if (h.icons)for (var z = h.icons.split(","),
                                                 y = z.length; y--;)CKEDITOR.skin.addIcon(z[y], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[y] + ".png");
                            d[f] = 1
                        }
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function (g, k, h) {
                ...
                y.onTagClose = function (a) {
                    ...
                    for (var c = [], d = [],
                             l = w; l != m && l.name != a;)l._.isBlockLike || d.unshift(l), c.push(l), l = l.returnPoint || l.parent;
                    if (l != m) {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                for (var d = 0, g = this.rules, k = g.length,
                         h; c && d < k; d++)h = g[d], a.nonEditable && !h.options.applyToAll || a.nestedEditable && h.options.excludeNestedEditable || (c = c.replace(h.value[0], h.value[1]));
                return c
            }
        }
    })();
                    ...
                    $: function (a) {
                        ...
                        if (b) {
                            ...
                            for (var c = ["name", "href", "src"], d,
                                     l = 0; l < c.length; l++)d = "data-cke-saved-" + c[l], d in b && delete b[c[l]]
                        }
                        return a
                    }, table: function (a) {
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), e = 0,
                                                      g = c.count(); e < g; e++)a = c.getItem(e), "true" == a.getAttribute("contenteditable") && (d = {
                element: a,
                config: {}
    ...
    (function () {
        ...
        m = function () {
            ...
            function b(c, d) {
                ...
                e = d.range.startPath();
                for (var k = p[k.getName()], h = 0, C = c.getChildren(), A = C.count(), D = -1, m = -1, r = 0,
                         H = e.contains(p.$list); h < A; ++h)e = C.getItem(h), a(e) ? (n = e.getName(), H && n in CKEDITOR.dtd.$list ? g = g.concat(b(e, d)) : (t = !!k[n],
                                ...
                                if (I && L.isElement) {
                                    ...
                                    if (y) F && (J = w.splitElement(F), m.zombies.push(J), m.zombies.push(F)); else {
                                        ...
                                        for (var U = [], aa = F.length, ba = 0, da = void 0,
                                                 ea = 0,
                                                 W = -1; ba < aa; ba++)da = F[ba], " " == da ? (ea || Y && !ba || (U.push(new CKEDITOR.dom.text(" ")), W = U.length), ea = 1) : (U.push(da), ea = 0);
                                        y && W == U.length && U.pop();
                                        Y = U
                                    }
                                }
            ...
            getNative: function () {
                ...
                var a = B ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, l, g = b.duplicate(), h = 0, k = e.length - 1, v = -1, n,
                                 m; h <= k;)if (v = Math.floor((h + k) / 2), f = e[v], g.moveToElementText(f), n = g.compareEndPoints("StartToStart", b), 0 < n) k = v - 1; else if (0 > n) h = v + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                    ...
                    return function () {
                        ...
                        if (d == CKEDITOR.SELECTION_ELEMENT) {
                            for (var d = [], e = 0; e < c.length; e++) {
                                for (var f = c.item(e), g = f.parentNode, l = 0,
                                         a = new CKEDITOR.dom.range(this.root); l < g.childNodes.length && g.childNodes[l] != f; l++);
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d,
                             e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && F[c.getName()] && (d = c)); e--)a.shrink(CKEDITOR.SHRINK_ELEMENT);
                    return d && d.$
                });
    ...
    (function () {
            ...
            if (c.collapsed) f = J(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                for (u.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (u = 0); u;) {
                    ...
                    if (u.equals(r)) u = null, k = !0; else {
                        ...
                        if (w && m && CKEDITOR.dtd.$block[z])for (var B = u, A = e(B), C = void 0, D = A.length, F = 0,
                                                                      B = D && new CKEDITOR.dom.range(B.getDocument()); F < D; ++F) {
                        ...
                        if (A)if (C = u.getParent(), A = h, D = g, F = l, !C || !(C.getDtd() || CKEDITOR.dtd.span)[D] && !F || A.parentRule && !A.parentRule(C)) k = !0; else {
                            if (t ||
                                ...
                                for (var z = u,
                                         R; (k = !z.getNext(H)) && (R = z.getParent(), n[R.getName()]) && d(R, q, h, P);)z = R;
                                t.setEndAfter(z)
                            }
                        } else k = !0;
                    ...
                    if (k && t && !t.collapsed) {
                        for (var k = J(this, f), w = k.hasAttributes(), x = t.getCommonAncestor(), z = {}, A = {},
                                 C = {}, D = {}, W, T, ca; k && x;) {
                            if (x.getName() == g) {
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()),
                         c = new CKEDITOR.dom.elementPath(n.getParent()), e = null, f = null,
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, g = 0,
                         h; g < e.elements.length && (h = e.elements[g]) && h != e.block && h != e.blockLimit; g++)if (this.checkElementRemovable(h)) {
                    var k;
        ...
        function h(a) {
            ...
            for (var d, e = a.document,
                     f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = J(this, e, d), r(d, f));
            a.moveToBookmark(b)
        }
        ...
        function y(a) {
            for (var b = l(this), c = a.getElementsByTag(this.element), d,
                     e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || z.call(this, d, !0);
        ...
        function d(b) {
            ...
            if (c)for (var c = c.split(",").sort(function (a, b) {
                    return a > b ? -1 : 1
                           ...
                           g; e < c.length; e++)if (g = c[e], d.ie && (g.replace(/^ie/, "") == d.version || d.quirks && "iequirks" == g) && (g = "ie"), d[g]) {
                b += "_" + c[e];
                break
            }
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c) {
                ...
                for (var b = c.editable(), a = b.isInline() && !c.plugins.divarea ? c.document : b,
                         b = a.getElementsByTag("a"), a = a.getElementsByTag("img"),
                         f = [], e = 0,
